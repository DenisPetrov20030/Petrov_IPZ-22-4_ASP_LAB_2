...
namespace HospitalSystem.Data.Models
{
	public class Appointment
	{
		...
		[Required(ErrorMessage = "Будь ласка, введіть дату і час прийому")]
		[DataType(DataType.DateTime)]
		public DateTime AppointmentDate { get; set; }

		[Required(ErrorMessage = "Будь ласка, введіть відділення")]
		[StringLength(50, ErrorMessage = "Назва відділення не може перевищувати 50 символів")]
		public string Department { get; set; } = String.Empty;

		[StringLength(500, ErrorMessage = "Примітка не повинна перевищувати 500 символів")]
